...
/*
When writer calls Lock()  then reader, writer are blocked
When reader calls RLock() then writer are blocked
When reader calls RLock() then other reader can access the data
*/
